        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <table class="customers">
                ...
                @foreach ($craftman as $man)
                    <tr>
                        <td>{{ $man->name }}</td>
                        <td>{{ $man->national_id }}</td>
                        <td>{{ $man->code }}</td>
                        <td>{{ $man->craft }}</td>
                        <td>{{ $man->phone }}</td>
                        <td>{{ $man->address }}</td>
                        <td>
                            <a class="btn btn-denger" href="{{ route('craftman.edit', $man->id) }}"><i
                                    class="fa-solid fa-pen-to-square"></i></a>
                            <form action="{{ route('crafteman.delete', $man->id) }}" method="POST"
                                style="display:inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-denger" class="text-denger"><i
