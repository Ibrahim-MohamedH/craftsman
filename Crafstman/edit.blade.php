                ...
                <div class="col-md-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <div class=" container">
                                {{-- NEW_CONTENT_ADDED_HERE --}}
                                <form method="POST" action="{{ route('craftman.update', $craftman->id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                            value="{{ $craftman->name }}" placeholder="Name"><br>
                                        <input type="text" class="form-control" name="national-ID"
                                            value="{{ $craftman->national_id }}" placeholder="National-ID"><br>
                                        {{-- <input type="text" class="form-control" name="Code"
                                            value="{{ $craftman->code }}" placeholder="Code"><br> --}}
                                        <input type="text" class="form-control" name="Crafst"
                                            value="{{ $craftman->craft }}" placeholder="Crafst"><br>
                                        <input type="text" class="form-control" name="Phone"
                                            value="{{ $craftman->phone }}"placeholder="Phone"><br>
                                        <input type="text" class="form-control" name="Address"
                                            value="{{ $craftman->address }}" placeholder="Address"><br>
