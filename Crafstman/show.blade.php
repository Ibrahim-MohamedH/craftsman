                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Name: {{ $craftman->name }}</label><br>
                                <label for="exampleFormControlInput1">Email: {{ $craftman->email }}</label><br>
                                <label for="exampleFormControlInput1">Phone: {{ $craftman->phone }}</label><br>
                                <label for="exampleFormControlInput1">Address: {{ $craftman->address }}</label><br>
                            ...
                            <div class="form-group">
                                <a class="btn btn-outline-secondary" href="{{ route('car.edit') }}"
                                    role="button">Back to delete</a>
                            </div>
                        </div>
                    </div>
                </div>
